...
* AppKey和AppSecret 参考《 [矽昌开放平台用户手册](https://jbctest.github.io/2020/09/12/open_platform_user_guide/) 》5.4.3 APP产品参数 章节描述。

* productKey 参考《 [矽昌开放平台用户手册](https://jbctest.github.io/2020/09/12/open_platform_user_guide/) 》5.4.1 硬件产品参数 章节描述。
...
参照[SiWiFi接口测试手册](https://jbctest.github.io/2020/09/11/SiWiFi_interface_test/)
