...
- 正常的编译和运行环境，请务必先阅读[快速入门](https://jbctest.github.io/2020/08/05/quick_start/)
...
参考[快速入门](https://jbctest.github.io/2020/08/05/quick_start/)，建议先直接编译一次所需镜像，然后使用2.1.2的方法。
...
2、通过uci命令修改，参考[config文件配置手册](https://jbctest.github.io/2020/09/11/config_setting/)
