...
## 2 项目引用
### 2.1 参考文档
参考[快速入门手册](https://jbctest.github.io/2020/08/05/quick_start/)
参考[GPIO使用手册](https://jbctest.github.io/2020/09/03/iomux_table/)
参考[Linux DTS说明文档](https://jbctest.github.io/2020/09/03/linux_dts_introduce/)
...
**使用led-button package进行管理**
  ...
  如果是新的版型引入，在此之前请确认版型已建立，如果没有请新建版型，siflower版型添加参考[新的版型引入指南](https://jbctest.github.io/2020/09/08/newBoardImportGuide/)
